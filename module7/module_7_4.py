...
print('Волшебники данных решили задачи за {}'.format(round(team2_time)))
# Использование f-строк:
print('\nИспользование f-строк:')
print(f'Команды решили {score_1} и {score_2} задач.')
print(f'Результат битвы: {challenge_result}')
print(
    f'Сегодня было решено {score_1 + score_2} задач, в среднем по {round((team1_time + team2_time) / (score_1 + score_2), 2)} секунды на задачу!.')
