...
if err==0:
    ...
    # Вариант с if
    res2 = 0
    if first == second and second==third: res2=3 # Самый редкий вариант (все равны)
    elif (first==second and first!=third) or (first==third and first!=second) or \
        (second==third and second!=first): res2=2 # Рассматриваем все варианты, когда есть два одинаковых числа
...
else: print("Неправильный ввод данных!")